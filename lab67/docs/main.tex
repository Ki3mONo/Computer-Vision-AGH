...
segmentację po kolorze. Uzyskaną maskę binarną czyścimy operacjami
...
model bierze 11 pomidorów za jabłka i 7 jabłek za pomidory.
...
wnosi \textbf{tekstura} (ważność GLCM 0,45; samodzielnie najlepsza rodzina,
$F_1$\,0,757), a~druga jest \textbf{barwa} (0,26) -- zwłaszcza histogram odcienia
i kanał $b^*$ z~Lab. Kształt (Zernike, Fourier, Hu, geometria) wnosi najmniej:
oba owoce są podobnie okrągłe. Pełny zestaw cech ($F_1$\,0,785) bije każdą
pojedynczą rodzinę, a maska HSV daje lepszy wynik niż Otsu (0,747 vs 0,738);
rzut PCA pokazuje silne nakładanie się klas, ograniczające skuteczność cech
klasycznych.
