...
\section{Wnioski}
% ============================================================ %
Klasyczny potok (segmentacja HSV, 203 cechy z trzech grup, strojenie
\texttt{GridSearchCV}) sklasyfikował jabłka i pomidory z accuracy 0,814 i
$F_1$\textsubscript{makro} 0,810, wyraźnie powyżej poziomu bazowego 0,557.
Najwięcej wniosła tekstura, wsparta kolorem; kształt okazał się mało przydatny
przy obiektach o zbliżonej, okrągłej sylwetce. Głównym ograniczeniem jest sam
zbiór -- obie klasy bywają czerwone i okrągłe, a część zdjęć to kiście lub
owoce pokrojone, co obniża górną granicę skuteczności metod klasycznych.
...
\bibitem{lbp} T.~Ojala, M.~Pietikäinen, T.~Mäenpää, \emph{Multiresolution
...
\bibitem{zernike} A.~Khotanzad, Y.~H. Hong, \emph{Invariant Image Recognition
  by Zernike Moments}, IEEE TPAMI, 1990.
\end{thebibliography}
